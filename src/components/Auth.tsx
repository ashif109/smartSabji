      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8 bg-white uppercase">
        ...
        >
          ...
          <button 
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-5 py-6 sm:py-8 bg-slate-900 text-white rounded-[32px] font-black text-xl sm:text-2xl uppercase tracking-tighter hover:bg-brand transition-all active:scale-[0.98] disabled:opacity-50 shadow-2xl shadow-slate-200"
          >
            {loading ? (
